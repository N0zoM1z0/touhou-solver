...
This refines
`notes/research/g5/G5_CALLBACK_LOOKAHEAD_COMPLETENESS_CONTRACT_20260728.md`. It changes
...
5. Retain Linux/Windows shipped-code timing reports and run both complete
   suites.
6. Update `START_HERE.md`, `STRATEGY.md`, `notes/COUNTEREXAMPLES.md`,
   `notes/RESEARCH_LOG.md`, and the consolidated roadmap in one verified
   checkpoint.
