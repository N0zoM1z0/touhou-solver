...
- Solver/model/issue rules: `CURRENT_SOLVER_CONTRACT.md`
- Combat, Focus, and Power: `CURRENT_COMBAT_RESOURCE_MODEL.md`
- Research plan: `review/TH08_LUNATIC_NMNB_RESEARCH_TASKBOOK.md`
- Native wind tunnel:
...
search archived history before the active contract has identified a concrete
gap.
