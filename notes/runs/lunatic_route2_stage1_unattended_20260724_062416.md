...
This is the accepted **pre-distant-recovery baseline**. All four hit windows
lost the global viability kernel 109--239 frames before contact, and the
one-cell repair neighborhood did not provide a sustained return direction.
The run motivates CE-0074; it is not evidence that local ten-frame control can
recover from a globally empty state.
