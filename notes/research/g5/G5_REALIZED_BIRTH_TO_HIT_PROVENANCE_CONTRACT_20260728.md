...
`notes/research/g5/TH08_FUTURE_BULLET_BIRTH_OBSERVATION_CONTRACT_20260728.md`. It is motivated
...
6. Record the exact-overlap counts and the frame-14,043 nonspell witness in
   `notes/COUNTEREXAMPLES.md`, `notes/RESEARCH_LOG.md`, `START_HERE.md`, `STRATEGY.md`,
