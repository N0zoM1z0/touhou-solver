...
This is the accepted **beam-contract performance and behavior gate** for
CE-0075, not a Stage-1 survival improvement. The corrected recovery priority
survived beam pruning on 560 distant-guidance queries, cadence remained
3/5 frames, and corridor bookkeeping remained 0.71/4.20 ms median/p95.

Total hits remained four. Their distribution moved from the preceding
candidate's nonspell/spell-1/spell-5 counts of 1/0/3 to 2/2/0, and pre-hit
bottom-eight-pixel occupancy fell from 17.3 to 1.4 percent. Because RNG and
post-respawn Power differ, this is evidence of a real behavior change but not
an aggregate survival claim. Random Stage 3 supplies the independent
cross-stage gate.
