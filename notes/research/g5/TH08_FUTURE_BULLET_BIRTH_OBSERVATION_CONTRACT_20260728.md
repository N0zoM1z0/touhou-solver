...
`notes/PIPELINE_ROOT_AND_HAZARD_COVERAGE_CONTRACT_20260727.md` for the first future
...
`notes/research/g5/G5_CALLBACK_LOOKAHEAD_COMPLETENESS_CONTRACT_20260728.md`. An instruction
...
`notes/research/g5/G5_CALLBACK_LOOKAHEAD_COMPLETENESS_CONTRACT_20260728.md`. Callback and
...
`notes/research/g5/G5_REALIZED_BIRTH_TO_HIT_PROVENANCE_CONTRACT_20260728.md` adds an orthogonal
