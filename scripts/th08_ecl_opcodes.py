...
_KNOWN = {
    ...
    0x84: ("set_timer_current", "boss", "inferred", "Set/reset a phase timer from an integer operand."),
    0x85: ("set_health_phase_transition", "boss", "observed", "Set indexed health threshold and the ECL subroutine started when health crosses it."),
    0x86: ("set_timeout_phase_transition", "boss", "observed", "Set timeout frame and the ECL subroutine started when the phase timer reaches it."),
