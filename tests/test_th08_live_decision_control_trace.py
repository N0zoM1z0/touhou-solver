...
class DecisionControlTraceTests(unittest.TestCase):
    ...
    def _decision() -> SimpleNamespace:
        values = {
            ...
            "preloss_supplemental_beam_width": 0,
            "preloss_historical_action": None,
            "preloss_selected_from_supplemental": False,
            "preloss_supplemental_candidate_count": 0,
            "preloss_historical_route_gate_deficit": None,
            "preloss_supplemental_failure": None,
            "preloss_supplemental_backend": None,
            "preloss_supplemental_status": None,
            "preloss_supplemental_completed": False,
            "preloss_supplemental_historical_fallback": False,
            "preloss_supplemental_background_compute_ms": None,
