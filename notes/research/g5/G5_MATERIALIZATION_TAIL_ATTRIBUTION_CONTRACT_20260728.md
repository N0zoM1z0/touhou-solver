...
`notes/research/g5/G5_NATIVE_BULLET_BIRTH_EXTRACTION_CONTRACT_20260728.md`.

The callback `COMPLETE`/`UNKNOWN` boundary remains
`notes/research/g5/G5_CALLBACK_LOOKAHEAD_COMPLETENESS_CONTRACT_20260728.md`. This experiment
