...
## Always-On Terminal-Threat Review

- This complete, no-Bomb trial is retained as a rejected implementation gate.
  Aggregate hits stayed at 27. Nonspell improved 16 to 12 and spell 57
  improved 6 to 5, but spells 65/69/73 regressed by 1/1/3 hits.
- The policy-lead improvement remained healthy: lead was 16/17 frames,
  completed policies rose 669 to 1,302, missing-query decisions fell 186 to
  61, and expired decisions fell 53 to 32.
- Always-on terminal threat covered 9,439 decisions, emitted 1,804
  sub-eight-pixel warnings, and cost too much in the real loop. Plan latency
  rose from 21.36/38.78 to 27.19/45.32 ms and cadence p95 rose from four to
  five frames.
- CE-0069 replaces always-on evaluation with a boundary-degeneracy trigger.
  Replaying this trace shows only 212 decisions would qualify: within four
  pixels of a boundary and no more than three distinct clamped successors.
  The rejected run remains evidence; it is not an acceptance baseline for the
