...
_KNOWN = {
    ...
    0x8D: ("spawn_item", "item", "observed", "Request one free-motion item of the supplied type at enemy position."),
    0x8E: ("spawn_item_bundle", "item", "observed", "Request a randomized +/-64 item bundle: one large then small Power below 128 Power, or all point items at full Power."),
    0x8F: ("set_drop_type", "item", "observed", "Set enemy primary defeat-item type at +0x3304."),
    0x90: ("set_drop_counts", "item", "observed", "Set enemy extra point-item count at +0x3308 and Power-item count at +0x330C."),
    ...
    0xA8: ("spawn_point_items", "item", "observed", "Request the supplied count of free-motion point items at independently randomized +/-64 positions around the enemy."),
