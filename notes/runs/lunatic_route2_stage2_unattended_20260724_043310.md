...
## Physical Differential Review

- Baseline `20260724_042005` had eight hits; this candidate had five.
  Nonspell fell from eight to four, spells 16/24/28 remained clean, and spell
  20 gained one hit. Native RNG means the aggregate is supporting evidence,
  not a repeated clean-pass estimate.
- The scheduler mechanism passed directly: lead median/p95 moved from 48/48
  to 16/18 frames, policy age from 25/46 to 13/26, completed policies from 387
  to 766, missing queries from 139 to 50, and expired decisions from 23 to 11.
  Decision cadence remained 3/4 frames.
- The spell-20 hit at frame 13,517 is CE-0068. At `y=429.64`, global guidance
  allowed `stay/down/down_fast`, three labels that clamp to almost one
  physical successor. Visible straight bullet slot 443 approached for over 30
  frames, outside the ten-frame local beam until escape was too late.
- Adaptive lead is accepted. The next correction is an inexpensive extended
  terminal-threat rollout used before stale repair-volume preference; it must
  not be mislabeled as a robust viability certificate.
