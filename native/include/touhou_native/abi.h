...
typedef struct TouhouLocalSupplementalQueryV1 {
    ...
    double initial_x;
    double initial_y;
    int32_t initial_first_action;
    int32_t initial_last_action;
    double initial_risk;
    int32_t initial_collisions;
    double initial_minimum_clearance;
    double initial_immediate_clearance;
    const int32_t* action_direction;
    const double* action_dx;
    const double* action_dy;
    const uint8_t* action_focused;
    const uint8_t* action_allowed;
    ...
    const int32_t* repair_volume;
    const int32_t* bullet_offsets;
    ...
    int32_t previous_direction;
    uint8_t previous_focused;
    int target_enabled;
    double target_x;
    double target_y;
    int target_deadline;
...
} TouhouLocalSupplementalQueryV1;

typedef struct TouhouLocalSupplementalOutputV1 {
    uint32_t struct_size;
    int capacity;
    double* x;
    double* y;
    int32_t* first_action;
    int32_t* last_action;
    double* risk;
    int32_t* collisions;
...
TOUHOU_ABI int touhou_local_supplemental_beam_reduce_v1(
    const double* draft_x,
    const double* draft_y,
    const int32_t* first_action,
    const int32_t* last_direction,
...
TOUHOU_ABI int touhou_local_supplemental_workspace_create_v1(
    void** output_workspace
);

TOUHOU_ABI int touhou_local_supplemental_workspace_cancel_v1(
    void* workspace_pointer
);

TOUHOU_ABI int touhou_local_supplemental_workspace_active_v1(
    void* workspace_pointer,
    int* output_active
);

TOUHOU_ABI int touhou_local_supplemental_workspace_destroy_v1(
    void* workspace_pointer
);

TOUHOU_ABI int touhou_local_supplemental_workspace_query_v1(
    void* workspace_pointer,
